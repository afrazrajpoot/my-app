...
export default function PaymentScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.payButton} onPress={handlePayPress} disabled={processing}>
        <Text style={styles.payButtonText}>{processing ? "Processing..." : "Pay"}</Text>
      </TouchableOpacity>
      <View style={{ marginTop: 20 }}>
        <TouchableOpacity style={styles.payButton} onPress={() => navigation.navigate("Map")}>
          <Text style={styles.payButtonText}>Go to map</Text>
        </TouchableOpacity>
      </View>
      <View style={{ marginTop: 20 }}>
        <TouchableOpacity style={styles.payButton} onPress={() => navigation.navigate("register")}>
